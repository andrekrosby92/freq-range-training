        ...
        <div>
          {answerState === "correct" && (
            <div className="space-y-4 flex flex-col items-center">
              ...
              <button
                className="text-white bg-[rgb(0,122,255)] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
